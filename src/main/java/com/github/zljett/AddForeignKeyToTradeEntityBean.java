 ...
 */
@Component("addForeignKeyBean")
public class AddForeignKeyToTradeEntityBean {

  @Autowired
  private MessageRepository messageRepository;

  public void setTradeForeignKey (TradeEntity body, @Headers Map<String, String> headers) {
