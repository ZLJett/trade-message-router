...
//  public void addHeadersPacket(String body, @Headers Map<String, String> headers) throws IOException {
//    String packetName = "BOC_STANDARD_XML_ZSE";
//    //add comments on each section, i.e. this creates a tree so don't have to load the full object
